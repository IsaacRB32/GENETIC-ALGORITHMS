...
def evaluar_aptitud_tsptw(ruta, t, Tw, lambda_penal=10):
    ...
    apertura_inicio = Tw[ruta[0]][0]
    if apertura_inicio != -float('inf'):
        T[0] = max(0, apertura_inicio)
...
def remocion_abruptos_insercion(ruta, t, Tw, m=3, lambda_penal=10):
    ...
    for i in hijo.copy():
        ...
        ## Buscamos en que posición de la ruta actual esta el vecino elegido
        ...
        ## 4. INSERTAR EL ELEMENTO EN LAS NUEVAS POSICIONES
        ## Opc 1: Insertar antes del vecino
        p1 = posiciones_ajustadas[0]
        ruta1 = ruta_temporal[:p1] + [i] + ruta_temporal[p1:]
        
        ## Opc 2: Insertar después del vecino
        ...
        ## Comparamos las 3 opciones y nos quedamos con la menor
...
def cruce_cycle_crossover(padre1, padre2):
    n = len(padre1)
    ...
    for i in range(n):
        if i not in posiciones_visitadas:
            ...
            ## Registramos todas las posiciones de este subciclo
            ...
            if ciclo % 2 == 0:
                ...
                ## Ciclo impar: Hijo1 copia de Padre2, Hijo2 copia de Padre1
                for pos in sub_ciclo:
...
for gen in range(num_generaciones):
    ...
    while len(nueva_poblacion) < tamano_poblacion:
        ...
        ## Cruce CX
        hijo1, hijo2 = cruce_cycle_crossover(padre1,padre2)
